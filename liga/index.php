<?php
 ...
 if (isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
  ...
  HTML::cabeceras(array('title'      =>'Pruebas LIGA 3',
			...
			'css'        => array('css/jquery-ui/liga/jquery-ui-1.9.2.liga.min.css',
																									'css/LIGA.css')
			'style'      =>'label { width:100px; }',
			'js' => array('js/jquery-3.1.1.min.js', 'js/jquery.liga-1.3.13.js', 'js/codigo.js') // agregacion de jquery
			)
		  );
 ...
 $cont = ob_get_clean();
  ...
  // Cierre de etiquetas HTML
		...
		$config = array('
																		js' =>array('js/jquery-3.1.1.min.js',
																														'js/jquery-liga.1.3.13.js',
																														'js/jquery-ui.min.js',
																														'js/codigo.js')
																		);
